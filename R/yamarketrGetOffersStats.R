...
# Что нужно добавить для релиза:
#   Разбивку загрузки по дням
#   Загрузка со всего списка кампаний.

library(yamarketr)
TokenPath <- "~/Documents/R/RWD/Market"
Campaigns <- yamarketrGetCampaigns("AgentsRBS", TokenPath)

Offers <- yamarketrGetOffers(Campaigns)

campaignId <- "21195327"

Login = "AgentsRBS"

offers2 <- yamarketrGetOffersCost(campaignId, TokenPath = TokenPath, Login = "AgentsRBS")
