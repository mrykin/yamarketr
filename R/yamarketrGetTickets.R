...
yamarketrGetTickets <- function(Campaigns, actualType = NULL, Login = NULL, TokenPath = getwd()){
  ...
  for(i in 1:nrow(Campaigns)){
    ...
    result <- rbind(result, data.frame(id = as.character(Campaigns$id[i]),
                                       ...
                                       errorCategory = as.factor(mapvalues(data$result$tickets$errorCode,
                                       ...
                                       checkMethod = as.factor(mapvalues(data$result$tickets$checkMethod,
                                                               from = c(1,2,3,4),
                                       ...
                                       status = as.factor(mapvalues(data$result$tickets$status,
                                                                    from = c(0,1),
